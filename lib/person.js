...
function createMainPerson(row, metadata) {
    ...
    if(country_born[0] != "") {
        ...
        if(country_born[0] != country_born[1]) Object.assign(area_born, { "other_names": [ country_born[1] ] });
    ...
    if(country_residence[0] != "") {
        ...
        if(country_residence[0] != country_residence[1]) Object.assign(area_residence, { "other_names": [ country_residence[1] ] });
